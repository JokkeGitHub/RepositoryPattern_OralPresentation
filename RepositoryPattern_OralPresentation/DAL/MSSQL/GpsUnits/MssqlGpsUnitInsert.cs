...
namespace RepositoryPattern_OralPresentation.DAL.MSSQL.GpsUnits
{
    public class MssqlGpsUnitInsert : MssqlConnection
    {
        public void Insert(GpsUnit gpsUnit)
        {
            ...
            command.CommandText = @"INSERT INTO GpsUnit(id, name, active, latitude, longitude, altitude, datetime) VALUES (@id, @name, @active, @latitude, @longitude, @altitude, @datetime)";
            ...
            command.Parameters.AddWithValue("@datetime", gpsUnit.Timestamp);
